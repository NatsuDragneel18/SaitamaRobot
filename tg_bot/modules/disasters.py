...
disasters = """ Anie has bot access levels we call as *"Disaster Levels"*
...
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in Anie.
\n*Demons* - Have access go globally ban users across Anie.
...
Report abuse or ask us more on these at [Heroes Association](https://t.me/Aniesupport).
"""
...
__help__ = f"""
 ...
 You can visit @Aniesupport to query more about these.
"""
